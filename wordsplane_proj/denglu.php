    ...
    <body>
        ...
        <div class="page-container">
            ...
            <form action="login.php" method="post">
                <input type="text" name="user_name_login" class="username" placeholder="username">
...
用户名<input type="text" name="user_name_login"><br/>
密码<input type="text" name="password_login"><br/>
